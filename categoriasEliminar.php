...
if (isset($_GET['id'])) {
  ...
  if ($ligacao->query($sql)) {
    ...
    $mensagem = "Erro ao eliminar a categoria. Pode estar associada a artigos.";
  }

} else {
  $mensagem = "ID da categoria não fornecido.";
}
?>
...
<head>
  ...
  <title>Eliminar categoria | Cardápio</title>
...
<section class="card shadow-sm rounded-4">
  <div class="card-body p-5 text-center">
    ...
    <h1 class="h3 mb-3">Eliminar categoria</h1>
